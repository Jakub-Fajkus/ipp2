...
echo "Running: $INTERPRETER $TASK.$EXTENSION --error 2> ${LOG_PATH}test01.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=nonexistent --output="${LOCAL_OUT_PATH3}test02.out" 2> ${LOG_PATH}test02.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input="${LOCAL_IN_PATH3}empty" --output=nonexistent/${LOCAL_OUT_PATH2}test03.out 2> ${LOG_PATH}test03.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input="${LOCAL_IN_PATH3}empty" --output=${LOCAL_OUT_PATH}test04.out --format=error-parameter.fmt 2> ${LOG_PATH}test04.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH}empty --output="${LOCAL_OUT_PATH3}test05.out" --format=error-size.fmt 2> ${LOG_PATH}test05.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH2}empty --output=${LOCAL_OUT_PATH}test06.out --format=error-color.fmt 2> ${LOG_PATH}test06.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input="${LOCAL_IN_PATH3}empty" --output="${LOCAL_OUT_PATH3}test07.out" --format=error-re.fmt 2> ${LOG_PATH}test07.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH2}empty --output="${LOCAL_OUT_PATH3}test08.out" --format=empty 2> ${LOG_PATH}test08.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH2}basic-parameter.in --output="${LOCAL_OUT_PATH3}test09.out" --format=basic-parameter.fmt 2> ${LOG_PATH}test09.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --format=basic-parameter.fmt --output="${LOCAL_OUT_PATH3}test10.out" --input=${LOCAL_IN_PATH}basic-parameter.in 2> ${LOG_PATH}test10.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --format=basic-parameter.fmt >"${LOCAL_OUT_PATH3}test11.out" <${LOCAL_IN_PATH}basic-parameter.in 2> ${LOG_PATH}test11.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH2}basic-re.in --output="${LOCAL_OUT_PATH3}test12.out" --format=basic-re.fmt 2> ${LOG_PATH}test12.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input="${LOCAL_IN_PATH3}special-re.in" --output="${LOCAL_OUT_PATH3}test13.out" --format=special-re.fmt 2> ${LOG_PATH}test13.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH2}special-symbols.in --output=${LOCAL_OUT_PATH2}test14.out --format=special-symbols.fmt 2> ${LOG_PATH}test14.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH}negation.in --output="${LOCAL_OUT_PATH3}test15.out" --format=negation.fmt 2> ${LOG_PATH}test15.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input="${LOCAL_IN_PATH3}multiple.in" --output="${LOCAL_OUT_PATH3}test16.out" --format=multiple.fmt 2> ${LOG_PATH}test16.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input="${LOCAL_IN_PATH3}multiple.in" --output="${LOCAL_OUT_PATH3}test17.out" --format=spaces.fmt 2> ${LOG_PATH}test17.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input="${LOCAL_IN_PATH3}newlines.in" --output=${LOCAL_OUT_PATH}test18.out --format=empty --br 2> ${LOG_PATH}test18.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH2}overlap.in --output="${LOCAL_OUT_PATH3}test19.out" --format=overlap.fmt 2> ${LOG_PATH}test19.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input="${LOCAL_IN_PATH3}special-symbols.in" --output="${LOCAL_OUT_PATH3}test20.out" --format=re.fmt 2> ${LOG_PATH}test20.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH2}example.in --br --format=example.fmt > "${LOCAL_OUT_PATH3}test21.out" 2> ${LOG_PATH}test21.err"
...
echo "Running: $INTERPRETER $TASK.$EXTENSION --input=${LOCAL_IN_PATH2}cprog.c --br --format=c.fmt > ${LOCAL_OUT_PATH2}test22.out 2> ${LOG_PATH}test22.err"
